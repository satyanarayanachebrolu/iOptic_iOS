...
typedef void (^AlertPromptWithButtonsCompletionBlock)(NSInteger userPressedButtonIndex);
...
/*! @fn showMessagePrompt:completionBlock
 @brief Displays an alert with an 'OK' button and a message.
 @param message The message to display.
 @param title The title.
 @param completion A block to call when the user taps 'OK'
 */
