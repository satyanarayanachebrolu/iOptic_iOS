...
- (void)showMessagePrompt:(NSString *)message withTitle:(NSString*)title completionBlock:(AlertPromptCompletionBlock)completion{
    ...
    if ([self supportsAlertController]) {
        ...
        [UIAlertController alertControllerWithTitle:title
                                     ...
                                     preferredStyle:UIAlertControllerStyleAlert];
        UIAlertAction *okAction =
        [UIAlertAction actionWithTitle:kOK style:UIAlertActionStyleDefault                                                          handler:^(UIAlertAction *_Nonnull action) {
            completion(YES, nil);
        }];
...
- (void)showMessagePrompt:(NSString *)message withTitle:(NSString*)title withButtonTitles:(NSArray*)buttonTitles completionBlock:(AlertPromptWithButtonsCompletionBlock)completion
{
    if ([self supportsAlertController]) {
        UIAlertController *alert =
        [UIAlertController alertControllerWithTitle:title
        ...
        for (NSString *buttonTitle in buttonTitles) {
            UIAlertAction *alertButton =
            [UIAlertAction actionWithTitle:buttonTitle style:UIAlertActionStyleDefault                                                          handler:^(UIAlertAction *_Nonnull action) {
                completion([buttonTitles indexOfObject:buttonTitle]);
            }];
