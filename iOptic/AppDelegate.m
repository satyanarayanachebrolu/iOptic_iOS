...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *moviePath = [bundle pathForResource:@"Splash_Animation" ofType:@"mp4"];
    if (moviePath)
    {
...
-(void)continueWithLaunch
{
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    iOpticTutorialViewController *tutorialViewController = [storyboard instantiateViewControllerWithIdentifier:@"iOpticTutorialViewController"];
